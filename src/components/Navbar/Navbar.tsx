...
const Header = () => {
	...
	return (
		<header className=" dark:bg-gray-900 dark:text-white shadow-md">
			<div className="max-w-7xl mx-auto flex items-center justify-between px-6 py-4">
				{/* Logo */}
				<Link
					to="/"
					className="text-2xl font-bold text-green-700 dark:text-lime-300"
				>
					FetanFews
				</Link>
				<div className=" md:flex gap-4">
					...
					<div className="flex items-center space-x-4">
						...
						<button
							...
							className="md:hidden text-3xl focus:outline-none text-gray-700 dark:text-white transition"
			...
			{menuOpen && (
				<div className="md:hidden px-6 py-4 space-y-4 text-sm font-medium  dark:bg-gray-800">
					{navLinks.map((link) => (
						<Link
							key={link.to}
							to={link.to}
