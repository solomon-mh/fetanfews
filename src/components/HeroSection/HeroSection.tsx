...
const HeroSection: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen grid items-center w-full bg-gradient-to-br from-gray-50 to-white dark:from-gray-900 dark:to-gray-950">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="space-y-6">
                ...
                >
                  We connect you with the medications you need and the
                  pharmacies that have them, ensuring you get your prescriptions
      ...
      <div className="px-12 lg:px-36 pb-6">
